...
const FreqGame = () => {
	...
	return (
		<div>
			<h1 className="text-3xlmd text-4xl font-bold mb-4 text-accent rounded-sm w-fit mx-auto px-4 py-2 uppercase">
				Frequencies <FaWaveSquare className="inline pb-2" />
			</h1>
			<div className="">
